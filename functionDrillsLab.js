...
function faveColorFinder(color){
  if(color === "red"){
    redReturn = "red is a great color";
    return redReturn;
  } else if(color === "green"){
    greenReturn = "green is a solid favorite color";
    return greenReturn;
  } else if(color === "black"){
    blackReturn = "so trendy";
    return blackReturn;
  } else {
    otherReturn = "you need to evaluate your favorite color choice";
    return otherReturn;
  }
}
...
function emailCheck(email){
  ...
  let trimEmail = emailString.trim();
  if(trimEmail.includes('@')){
    let vrfdEmail = "Email verified";
    return vrfdEmail;
  } else {
    let noEmail = "Must provide a valid email address";
    return noEmail;
  }
}

let readEmail = emailCheck("cjowen14@outlook.com");
